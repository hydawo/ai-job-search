...
7. **NEVER volunteer a gap disclaimer on your own judgment.** Do not write sentences that name something Hassan hasn't done ("I haven't personally run an FDA-regulated device trial from protocol through submission, and I want to be direct about that rather than imply otherwise", "While I don't have direct experience in X..."). **This holds whether or not the posting requires the thing.** A posting listing the qualification makes the disclaimer *arguable*, never automatic: whether to concede a gap in writing, rather than handle it in an interview, is Hassan's call about his own candidacy and not a drafting decision. The default is to omit it and let the strengths carry the letter.
   When a posting names a hard requirement Hassan doesn't meet, surface it after drafting instead: "The posting requires X, which you don't have. Address it in the letter, or leave it for interview?" Draft without the disclaimer while waiting, since adding one is a smaller edit than unpicking it.
   *Origin: a WHOOP Director, Clinical Operations letter (2026-08-21) opened a whole paragraph conceding no FDA/GCP device-trial experience. It sat unread in a live application for twelve days. Hassan removed it on sight 2026-09-02 and did not recognize where it came from.*

...
**Output file:** `cover_letters/dawood_cover_<company>_<role>.tex`
...
Expected output: `Output written on dawood_cover_<company>_<role>.pdf (1 page, ...)`. Any page count other than 1 is a failure that must be fixed before presenting to the user.
...
1. Run `xelatex -interaction=nonstopmode dawood_cover_<company>_<role>.tex`

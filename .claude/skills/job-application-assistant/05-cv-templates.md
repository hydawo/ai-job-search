...
**Output file:** `cv/dawood_cv_<company>_<role>.tex`
...
Expected output: `Output written on dawood_cv_<company>_<role>.pdf (2 pages, ...)`. Any page count other than 2 is a failure that must be fixed before presenting to the user.
...
1. Run `lualatex -interaction=nonstopmode dawood_cv_<company>_<role>.tex`

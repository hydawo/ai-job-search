...
- Read any existing `cv/dawood_cv_*<CV_EXT>` file as a structural reference
- Read any existing `cover_letters/dawood_cover_*<COVER_EXT>` file as a structural reference
...
### CV (`cv/dawood_cv_<company>_<role><CV_EXT>`)
...
### Cover Letter (`cover_letters/dawood_cover_<company>_<role><COVER_EXT>`)
...
<CV_DRAFT file="cv/dawood_cv_<COMPANY>_<ROLE><CV_EXT>">
<INSERT_CV_DRAFT_HERE>
</CV_DRAFT>

<COVER_LETTER_DRAFT file="cover_letters/dawood_cover_<COMPANY>_<ROLE><COVER_EXT>">
...
```json
{
  "file": "cv/dawood_cv_<COMPANY>_<ROLE><CV_EXT>" | "cover_letters/dawood_cover_<COMPANY>_<ROLE><COVER_EXT>",
...
```bash
cd cv && lualatex -interaction=nonstopmode dawood_cv_<company>_<role>.tex
cd ../cover_letters && xelatex -interaction=nonstopmode dawood_cover_<company>_<role>.tex
```
...
**CV (`cv/dawood_cv_<company>_<role>.pdf`):**
...
**Cover letter (`cover_letters/dawood_cover_<company>_<role>.pdf`):**
- [ ] Exactly 1 page
...
```bash
cd cv && pdftotext -layout dawood_cv_<company>_<role>.pdf dawood_cv_<company>_<role>.txt
```

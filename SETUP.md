...
```bash
# Bash / zsh / Git Bash
cd cv && lualatex <lastname>_cv_<company>_<role>.tex && cd ..
cd cover_letters && xelatex <lastname>_cover_<company>_<role>.tex && cd ..
```

```powershell
# PowerShell
Set-Location cv; lualatex <lastname>_cv_<company>_<role>.tex; Set-Location ..
Set-Location cover_letters; xelatex <lastname>_cover_<company>_<role>.tex; Set-Location ..
```

...
**Needs verification before external use:** this is personal, non-clinical, N=1 exploratory work — whether and how to present a personal health-tracking side project on a CV/in an interview (strong evidence of self-directed analytical rigor vs. off-topic for the role) is a real judgment call, not an obvious yes. Discuss with Hassan before using rather than assuming it belongs on a resume; it may be better suited to interview conversation than a written bullet.
**Last checked:** 2026-08-13
